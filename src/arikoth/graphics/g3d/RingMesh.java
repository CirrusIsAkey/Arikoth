...
public class RingMesh extends PlanetMesh{
  ...
  private static Shader shader(){
    return ArikothRingShader.planetTextureShader;
  }

  @Override
  public void preRender(PlanetParams params){
    ArikothRingShader.planetTextureShader.planet = this.planet;

    if(planet == null || planet.solarSystem == null){
      return;
    }
    ArikothRingShader.planetTextureShader.lightDir
            .set(planet.solarSystem.position)
            .sub(planet.position)
            .rotate(Vec3.Y, planet.getRotation())
            .nor();

    ArikothRingShader.planetTextureShader.ambientColor
            .set(planet.solarSystem.lightColor);

    ArikothRingShader.planetTextureShader.alpha = 1f;
  }
  ...
  public void render(PlanetParams params, Mat3D projection, Mat3D transform){
    ...
    shader.setUniformf("u_lightdir", ArikothRingShader.planetTextureShader.lightDir);
    shader.setUniformf("u_ambientColor", ArikothRingShader.planetTextureShader.ambientColor);
    shader.setUniformf("u_alpha", ArikothRingShader.planetTextureShader.alpha);
