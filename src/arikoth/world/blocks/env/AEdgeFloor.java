...
import arikoth.graphics.FreeableAtlas;
 ...
 * @author GlFolker
 */
public class AEdgeFloor extends AFloor {
    public TextureRegion[][][] edges;
    public TextureRegion stencil;
    /** If {@code true}, edges will use regions for the originating tile instead of the target tile. */
    public boolean absolute = false;

    public AEdgeFloor(String name) {
        super(name);
    }

    public AEdgeFloor(String name, int variants) {
        super(name, variants);
    }

    public AEdgeFloor(String name, int variants, Color cliffLightColor, Color cliffDarkColor) {
        super(name, variants);
