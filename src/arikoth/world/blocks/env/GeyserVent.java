...
public class GeyserVent extends Floor {
    ...
    public float effectSpacing = 300f;
    public float effectRandom = 0.5f;
    ...
    public void renderUpdate(UpdateRenderState state){
        if(Mathf.chanceDelta(effectRandom) && state.tile.nearby(-1, -1) != null && state.tile.nearby(-1, -1).block() == Blocks.air && (state.data += Time.delta) >= effectSpacing * effectRandom){
