...
public class DrawScannerLine extends DrawBlock implements Cloneable{
    ...
    public DrawScannerLine copyAnd(Cons<DrawScannerLine> modifier){
        DrawScannerLine n = copy();
        modifier.get(n);
        return n;
    }

    public DrawScannerLine copy(){
        try{
            return (DrawScannerLine)super.clone();
