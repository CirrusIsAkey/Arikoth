...
public class VoidLaserBulletType extends LaserBulletType {
    ...
    public float width = 15f, blackIn = 10;
    ...
    public VoidLaserBulletType(float damage){
        this.damage = damage;
        this.speed = 0f;
    ...
    public void draw(Bullet b){
        ...
        float newWidth = width - blackIn;
        Draw.z(Layer.bullet - 0.05f);
        Draw.color(Color.black);
        Lines.stroke((newWidth *= lengthFalloff) * b.fout());
        Lines.lineAngle(b.x, b.y, b.rotation(), baseLen, false);
        Tmp.v1.trns(b.rotation(), baseLen);
        Drawf.tri(b.x + Tmp.v1.x, b.y + Tmp.v1.y, Lines.getStroke(), newWidth * 2f + width / 2f, b.rotation());

        Fill.circle(b.x, b.y, 1f * newWidth * b.fout());
        for(int i : Mathf.signs){
            Drawf.tri(b.x, b.y, sideWidth * b.fout() * newWidth, sideLength * compound, b.rotation() + sideAngle * i);
        }
