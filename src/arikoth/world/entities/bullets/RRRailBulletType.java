...
import static arikoth.world.entities.bullets.AftershockBulletType.rand;

public class RRRailBulletType extends RailBulletType {
    ...
    public void init(Bullet b){
        ...
        rand.setSeed(b.id);
        b.fdata = length * rand.random(0.5f, 1);
