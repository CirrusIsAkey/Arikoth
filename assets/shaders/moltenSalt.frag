...
#define S1 vec3(128.0, 126.0, 140.0) / 255.0
#define S2 vec3(173.0, 173.0, 173.0) / 255.0
...
void main(){
    ...
    float wave = abs(sin(coords.x * -0.4 + coords.y) + 0.05 * sin(2.2 * coords.x) + 0.05 * sin(0.2 * coords.y)) / 30.0;
